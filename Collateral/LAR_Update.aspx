<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LAR_Update.aspx.cs" Inherits="Collateral.LAR_Update" %>
...
<div id="divContainer" style="background-color: #fff; padding: 50px; margin-top: -40px;">
   ...
   <table  id="tblContainer"class="auto-style17"  style="padding-bottom: 5px;">
      ...
      <tr>
         ...
         <td class="auto-style71">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtceo" ErrorMessage="X" Font-Names="Bahnschrift" Font-Size="XX-Small" ForeColor="Red" InitialValue="selectbod"></asp:RequiredFieldValidator>
         </td>
         <td class="auto-style18">
      ...
      <tr>
         ...
         <td class="auto-style13">
            <asp:DropDownList ID="txtBODRequirement" runat="server" CssClass="btn-info" AutoPostBack="true" Font-Bold="True" OnSelectedIndexChanged="txtBODRequirement_SelectedIndexChanged" Font-Names="Bahnschrift" Font-Size="Smaller" Font-Strikeout="False" Font-Underline="False" ForeColor="White" Height="40px" Width="196px" TabIndex="5">
                <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
            </asp:DropDownList>
         </td>
 ...
 <asp:Panel ID="bod1" runat="server" Visible="false">
         ...
         <td class="auto-style32">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtbod1" ErrorMessage="X" Font-Names="Bahnschrift" Font-Size="XX-Small" ForeColor="Red"  InitialValue="selectHM"></asp:RequiredFieldValidator>
         </td>
         <td class="auto-style18">
 ...
 <asp:Panel ID="bod3" runat="server" Visible="false">
         ...
         <td class="auto-style18">
            <asp:DropDownList ID="txtFacilityStatus" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Smaller" Font-Strikeout="False" Font-Underline="False" ForeColor="White" Height="40px" Width="196px" TabIndex="5">
               <asp:ListItem Text="Select" Value="selectFS"></asp:ListItem>
      ...
      <tr>
         ...
         <td class="auto-style10">
            <strong>
               <asp:Button ID="updBtn" runat="server" CssClass="btn-primary" Height="37px" Text="update" Width="81px" Font-Bold="True" Font-Size="Small" TabIndex="14" OnClick="updBtn_Click" BorderStyle="None" />
            </strong>
         </td>
      </tr>
   </table>
