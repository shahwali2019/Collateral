...
<asp:Panel runat="server" DefaultButton="searchBtn">
   <table>
      <tr style="padding: 10px 10px;">
         <td>
            <asp:TextBox ID="txtCname" placeholder="Client Name" runat="server" Height="31px" Width="168px" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" TabIndex="2" CssClass="form-control"></asp:TextBox>
         </td>
         <td>&nbsp;</td>
         <td>
...
<div>
   <div class="table">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <asp:GridView CssClass="GridPager" ID="GridView1" OnRowDataBound="GridView1_RowDataBound" runat="server" OnRowCommand="GridView1_RowCommand" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False"  DataKeyNames="id" DataSourceID="StringCon" EnableTheming="True"  BorderStyle="None">
                  <Columns>
