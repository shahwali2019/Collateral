...
<div style="height:90px; text-align: center; margin: 0 auto; margin-top:10px;" class="alert alert-success" role="alert">
   <h4 class="alert-heading" style="font-family: Bahnschrift;">
      <strong>
         <asp:Label ID="addLbl" runat="server" Text="TITLE DEEDS RECORD"></asp:Label>
      </strong>
   </h4>
</div>
...
<div>
   ...
   <br />
   <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="False"
      ...
      <Columns>
         <asp:TemplateField HeaderText="All">
            ...
            <ItemTemplate>
               <asp:CheckBox ID="childch" runat="server" />
            </ItemTemplate>
         ...
         <asp:TemplateField HeaderText="Released Submitted to" SortExpression="Released Submitted to">
            <EditItemTemplate>
               <asp:TextBox ID="TextBox200" runat="server" Text='<%# Bind("[Released Submitted to]") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
               <asp:Label ID="Label210" runat="server" Text='<%# Bind("[Released Submitted to]") %>'></asp:Label>
            </ItemTemplate>
            <HeaderStyle CssClass="center" />
            <ItemStyle CssClass="center" />
         </asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="Remark" SortExpression="Remark">
            <EditItemTemplate>
               <asp:TextBox ID="TextBox31" runat="server" Text='<%# Bind("Remark") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
               <asp:Label ID="Label32" runat="server" Text='<%# Bind("Remark") %>'></asp:Label>
            </ItemTemplate>
            <ControlStyle CssClass="center" />
            <HeaderStyle CssClass="center" />
            <ItemStyle CssClass="center" />
