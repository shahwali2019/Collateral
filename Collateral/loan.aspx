...
<strong>
   ...
   <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"  OnRowCommand="GridView1_RowCommand"  AutoGenerateColumns="False" DataKeyNames="id" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Horizontal">
...
<asp:SqlDataSource ID="SqlCon2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
    DeleteCommand="DELETE FROM [Loanadder_tbl2] WHERE [id] = @id order by id desc" 
    InsertCommand="INSERT INTO [Loanadder_tbl2] ([bname], [pdate], [Telecom], [dino], [ourRef], [CardSerialStart], [CardSerialEnd], [Qty], [CartonValAfn], [status], [ReleaseDate], [RotationDate], [SecRotationDate], [ThirdRotationDate]) VALUES (@bname, @pdate, @Telecom, @dino, @ourRef, @CardSerialStart, @CardSerialEnd, @Qty, @CartonValAfn, @status, @ReleaseDate, @RotationDate, @SecRotationDate, @ThirdRotationDate)" SelectCommand="SELECT * FROM [Loanadder_tbl2]" 
    UpdateCommand="UPDATE [Loanadder_tbl2] SET [bname] = @bname,
   [pdate] = @pdate, 
   [Telecom] = @Telecom,
   [ourRef] = @ourRef,
