...
<table border="0" class="auto-style17" style=" ">
  <tr>
    <td class="auto-style1" colspan="4">
      ...
      <div runat="server" id="datePicker" style="">
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="btn-success" Font-Names="Bahnschrift" Height="30px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="62px">
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="btn-success" Font-Names="Bahnschrift" Height="30px" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
        ...
        <div style=" width:60px; margin-left:103px; margin-top:-30px;">
          <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="true" CssClass="btn-success" Font-Names="Bahnschrift" Font-Size="Medium" Height="30px" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" Width="62px">
  ...
  <tr>
    <td class="auto-style71"> Client Name <strong>
    ...
    <td class="auto-style61"> Hujat Khaat N <strong>o.#</strong>
    </td>
  ...
  <tr>
    <td class="auto-style71"> Type of Loan <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style74">
      <asp:DropDownList ID="drop_loantype" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Height="40px" Width="196px" TabIndex="1">
        ...
        <asp:ListItem Text="Loan Draft" Value="Loan Draft"></asp:ListItem>
    ...
    <td class="auto-style61"> &nbsp;Hujat Khat Date</td>
    <td class="auto-style30">
  ...
  <tr>
    <td class="auto-style71"> Type of Qabala <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61"> Hujat Khat Value</td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style3">
  ...
  <tr>
    <td class="auto-style71"> Qabala Number <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61"> Equitable Mortg_ N <strong>o.</strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style3">
  ...
  <tr>
    <td class="auto-style72"> Qabala Date <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    ...
    <td class="auto-style65"> Equitable Mortg_ Date</td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style67">
      <asp:TextBox ID="txtEMD" runat="server" autocomplete="off" class="date" Height="40px" MaxLength="10" placeholder="mm/dd/yyyy" Width="197px" TabIndex="20" TextMode="Date" />
    </td>
  </tr>
  <tr>
    <td class="auto-style71"> Owner of Qabala <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61"> Reason for Released <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
  ...
  <tr>
    <td class="auto-style71"> Type of Property <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style74">
      <asp:DropDownList ID="drop_PropertyType" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Height="40px" Width="196px" TabIndex="7">
        ...
        <asp:ListItem>Commercial/Residential</asp:ListItem>
        <asp:ListItem>Commercial/Open Land</asp:ListItem>
        <asp:ListItem>Residential/Open Land</asp:ListItem>
        <asp:ListItem>Residential/Commercial</asp:ListItem>
      </asp:DropDownList>
    </td>
    <td class="auto-style61">
      <strong>Pending Item(s)</strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style3">
  ...
  <tr>
    <td class="auto-style71"> C <strong>urrency Type <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style74"><%-- 
			<asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>--%> <asp:UpdatePanel ID="UpdatePanel7" runat="server">
        <ContentTemplate>
          <asp:DropDownList ID="drop_Currency" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Height="40px" TabIndex="9" Width="196px">
    ...
    <td class="auto-style61"> &nbsp;Due Date(Pending Docs)</td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style3">
  ...
  <tr>
    <td class="auto-style71">
      <strong>Value of Property <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61">
      <strong>Received By <span style="color:red;">*</span>&nbsp;&nbsp; </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86">
    ...
    <td class="auto-style3">
         ...
         <td class="auto-style73"> Released/Submitted to <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86">
      <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtClient" ErrorMessage="x" ForeColor="Red"></asp:RequiredFieldValidator>
    </td>
    <td class="auto-style38">
      <asp:TextBox ID="txtrels_subm" CssClass="center" runat="server" Height="40px" Width="196px" Font-Bold="True" Font-Size="Smaller" TabIndex="24" OnTextChanged="txtRB_TextChanged"></asp:TextBox>
  ...
  <tr>
    <td class="auto-style70"> Property Evaloator <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style75">
      <asp:TextBox ID="txtevaluator" CssClass="center" runat="server" Height="40px" Width="196px" Font-Bold="True" TabIndex="10" OnTextChanged="txtevaluator_TextChanged"></asp:TextBox>
        ...
        <td class="auto-style73"> Status <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
  ...
  <tr>
    <td class="auto-style71"> Address <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61"> Remark</td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
    <td class="auto-style38">
  ...
  <tr>
    <td class="auto-style71">Last Evaluation Date <strong>
        <span style="color:red;">*</span>
      </strong>
    </td>
    <td class="auto-style30">
    ...
    <td class="auto-style61"> Add Loan Status</td>
    <td class="auto-style30">
    <td class="auto-style86"> &nbsp;
    <td style="width: 209px">
      <asp:DropDownList ID="Drop_LoanStatus" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Height="40px" Width="196px" TabIndex="27">
  ...
  <tr>
    <td class="auto-style71">&nbsp;Reg. Mortgage N <strong>o.#</strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    ...
    <td class="auto-style61"> Inserted Date <strong>
        <span id="Star4" style="color:red;" runat="server">* <span id="Star6" style="color:red;" runat="server">(sys Date)</span>
        </span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    ...
    <td class="auto-style8">
      <strong>
        <span id="Star5" style="color:red;" runat="server">
  ...
  <tr>
    ...
    <td class="auto-style61">
      ...
      <strong>
        <span id="Star1" style="color:red;" runat="server">*</span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
  ...
  <tr>
    ...
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style76">
      <asp:TextBox ID="txtMValue" CssClass="center" runat="server" Height="40px" Width="196px" Font-Bold="True" Font-Size="Small" TabIndex="15"></asp:TextBox>
    </td>
    <td class="auto-style61">
      <asp:Label ID="RelBy" runat="server" Text="Released By"></asp:Label>
      <strong>
        <span id="Star2" style="color:red;" runat="server">*</span>
      </strong>
    </td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style86"> &nbsp;</td>
  ...
  <tr>
    <td class="auto-style71">Currency</td>
    <td class="auto-style30"> &nbsp;</td>
    <td class="auto-style38">
      <asp:DropDownList ID="txtcurrency_crtg" runat="server" CssClass="btn-info" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="Small" Height="40px" Width="196px" TabIndex="25">
        <asp:ListItem>Currency</asp:ListItem>
        <asp:ListItem>AFN</asp:ListItem>
        <asp:ListItem>USD</asp:ListItem>
      </asp:DropDownList>
  ...
  <tr>
    <td class="auto-style1" colspan="2" rowspan="2"></td>
    <td class="auto-style79"></td>
    <td class="auto-style84">
      <asp:Label ID="RelDate" runat="server" Text="Release Date"></asp:Label>
      <strong>
        <span id="Star3" style="color:red;" runat="server">*</span>
      </strong>
    </td>
