...
namespace Collateral
{
    public partial class obsr_loan_docs_pending : System.Web.UI.Page
    {
        ...
        protected void gvobservloan_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connectionString))
            {
                foreach (GridViewRow gw in gv3.Rows)
                {
                    ...
                    if (chkSelect.Checked)
                    {
                        ...
                        Val17 = (gw.FindControl("Label17") as Label).Text; //[Borrower]
                        Val18 = (gw.FindControl("Label18") as Label).Text; //[Borrower]
                        ...
                        string queryy = "UPDATE [OLDs] SET" + "[Document checking date] =@val2" + //Document checking date
                        ",[Borrower] =@val3" + //Borrower
                        ",[Department] =@val17" + //Department
                        ",[Purpose of Application] =@val18" + //Department
                        ...
                        ",[Updated By]=@val16 " + //Status of Observation
                        " WHERE id=@val1";
            ...
            using (SqlConnection sqlCon = new SqlConnection(ConStr))
            {
                ...
                foreach (GridViewRow gw in gvobservloan.Rows)
                {
                    ...
                    if (chkSelect.Checked)
                    {
                        ...
                        Val17 = (gw.FindControl("Label17") as Label).Text; //currency
                        Val18 = (gw.FindControl("Label18") as Label).Text; //currency
                        ...
                        sqlcmd.Parameters.AddWithValue("@val12", Val12); //
                        sqlcmd.Parameters.AddWithValue("@val13", Val13); //
                        sqlcmd.Parameters.AddWithValue("@val14", username); // 
                        sqlcmd.Parameters.AddWithValue("@val15", Val15); //
                        sqlcmd.Parameters.AddWithValue("@val16", Val16); //
