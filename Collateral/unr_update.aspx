<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="unr_update.aspx.cs" Inherits="Collateral.unr_update" %>
...
<div id="divContainer" style="background-color: #fff; padding: 50px; margin-top: -40px;">
	<div style="height: 120px; padding-left: 32%; border-top: 10px solid #0094ff; margin-top: -20px;" class="alert alert-success" role="alert">
      ...
      <strong>
         <asp:Label ID="addLbl" runat="server" Text="UNDER NOTICE RECORD UPDATE"></asp:Label>
      </strong>
	...
	<table id="tblContainer" class="auto-style17" style="padding-bottom: 5px;">
		...
		<tr>
			...
			<td class="auto-style10"> <strong>
               <asp:Button ID="updateBtn" runat="server" CssClass="btn-primary" Height="37px" Text="ADD" Width="81px" Font-Bold="True" Font-Size="Small" TabIndex="14" OnClick="updateBtn_Click" BorderStyle="None" />
            </strong>
			</td>
		</tr>
	</table>
