...
<div style=" height:90px; text-align:center; margin-left:10px; border-top:10px solid #0094ff; margin-top:0; padding-top:30px;" class="alert alert-success"  role="alert">
   <h4 class="alert-heading" style=" font-family:Bahnschrift;">
      <strong>
         <asp:Label ID="addLbl" runat="server" >VAULT RECORD OF LOANS</asp:Label>
      </strong>
   </h4>
</div>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
   <ContentTemplate>
      ...
      <div  style="margin-left:350px; margin-top:-29px;">
         <asp:ImageButton  ID="ImageButton2" runat="server" Height="22px" ImageUrl="~/image/refresh.jpg" OnClick="ImageButton2_Click" Width="24px" />
      </div>
   </ContentTemplate>
</asp:UpdatePanel>
<br />
...
<%--   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
   <ContentTemplate>--%>
<asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" 
   ...
   <Columns>
      ...
      <asp:TemplateField HeaderText="Cabine|Safe Ref" SortExpression="SafeRef">
         ...
         <ItemTemplate>
            <asp:Label ID="Label19" runat="server" Text='<%# Bind("SafeRef") %>'></asp:Label>
         </ItemTemplate>
         <ControlStyle CssClass="center" />
         <HeaderStyle CssClass="center" />
         <ItemStyle CssClass="center" />
...
<asp:SqlDataSource ID="DbCon" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT * FROM [Wak_Tbl]">
   <DeleteParameters>
