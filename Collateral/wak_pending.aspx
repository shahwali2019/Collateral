...
<div class="main">
   ...
   <br />
   <asp:SqlDataSource ID="SqlCon2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" DeleteCommand="DELETE FROM [Wak_Tbl_temp] WHERE [id] = @id" InsertCommand="INSERT INTO [Wak_Tbl_temp] ([ClientName], [FacilityApproval], [FacilityType], [FacilityStatus], [SafeNo], [drawer], [FolderNo], [Extention], [modification], [SafeInDate], [DocStatus], [SafeOutDate], [Remark], [InsertedBy]) VALUES (@ClientName, @FacilityApproval, @FacilityType, @FacilityStatus, @SafeNo, @drawer, @FolderNo, @Extention, @modification, @SafeInDate, @DocStatus, @SafeOutDate, @Remark, @InsertedBy)" SelectCommand="SELECT * FROM [Wak_Tbl_temp]" UpdateCommand="UPDATE [Wak_Tbl_temp] SET [ClientName] = @ClientName, [FacilityApproval] = @FacilityApproval, [FacilityType] = @FacilityType, [FacilityStatus] = @FacilityStatus, [SafeNo] = @SafeNo, [drawer] = @drawer, [FolderNo] = @FolderNo, [Extention] = @Extention, [modification] = @modification, [SafeInDate] = @SafeInDate, [DocStatus] = @DocStatus, [SafeOutDate] = @SafeOutDate, [ArchDate] = @ArchDate, [Remark] = @Remark, [InsertedBy] = @InsertedBy WHERE [id] = @id">
      <DeleteParameters>
         <asp:Parameter Name="id" Type="Int32" />
      </DeleteParameters>
   </asp:SqlDataSource>
   <asp:GridView ID="GridView2" OnRowCommand="GridView2_RowCommand" OnRowDataBound="GridView2_RowDataBound" runat="server" ShowHeaderWhenEmpty="True" AllowSorting="True" CssClass="auto-style1" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" DataSourceID="SqlCon2" PageSize="7" Width="645px" Visible="False" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" GridLines="Horizontal">
      <AlternatingRowStyle BackColor="#99FF99" />
      <Columns>
                   <asp:TemplateField ShowHeader="true" HeaderText="Delete">
            <ItemTemplate>
               <asp:LinkButton ID="DeleteLbl" runat="server" CommandArgument='<%# Bind("id") %>' CausesValidation="False" CommandName="delete" Text="Delete"></asp:LinkButton>
            </ItemTemplate>
         ...
         <asp:TemplateField HeaderText="approved By" SortExpression="approved By">
            ...
            <ItemTemplate>
               <asp:Label ID="Label16" runat="server" Text='<%# Bind("approvedBy") %>'></asp:Label>
            </ItemTemplate>
            <ControlStyle CssClass="center" />
            <HeaderStyle CssClass="center" />
            <ItemStyle CssClass="center" />
         ...
         <asp:TemplateField HeaderText="updatedBy" SortExpression="updatedBy">
            ...
            <ItemTemplate>
               <asp:Label ID="Label17" runat="server" Text='<%# Bind("updatedBy") %>'></asp:Label>
            </ItemTemplate>
            <ControlStyle CssClass="center" />
            <HeaderStyle CssClass="center" />
            <ItemStyle CssClass="center" />
   ...
   <div style="margin-top:-5px;">
      <asp:GridView ID="GridView3" OnRowCommand="GridView3_RowCommand" OnRowDataBound="GridView3_RowDataBound" DataKeyNames="id" runat="server" ShowHeaderWhenEmpty="True" AllowSorting="True" CssClass="auto-style1" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlConUpdate" PageSize="7" Width="910px" Visible="False" OnSelectedIndexChanged="GridView3_SelectedIndexChanged" GridLines="Horizontal">
         <AlternatingRowStyle BackColor="#99FF99" />
         <Columns>
            ...
            <asp:TemplateField ShowHeader="true" HeaderText="">
               <ItemTemplate>
                  <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Bind("id") %>' CausesValidation="False" CommandName="Insert" Text=""></asp:LinkButton>
               </ItemTemplate>
               <ControlStyle CssClass="center" />
               <HeaderStyle CssClass="center" />
               <ItemStyle CssClass="center" />
            ...
            <asp:TemplateField HeaderText="Cabine | Safe Ref" SortExpression="SafeRef">
               ...
               <ItemTemplate>
                  <asp:Label ID="Label17" runat="server" Text='<%# Bind("SafeRef") %>'></asp:Label>
               </ItemTemplate>
               <ControlStyle CssClass="center" />
               <HeaderStyle CssClass="center" />
               <ItemStyle CssClass="center" />
            ...
            <asp:TemplateField HeaderText="Archived Date" SortExpression="ArchDate">
               ...
               <ItemTemplate>
                  ApproveUpdateBtn_Click
                  <asp:Label ID="Label18" runat="server" Text='<%# Bind("ArchDate") %>'></asp:Label>
               </ItemTemplate>
               <ControlStyle CssClass="center" />
               <HeaderStyle CssClass="center" />
               <ItemStyle CssClass="center" />
   ...
   <asp:SqlDataSource ID="SqlConUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT * FROM [Wak_update_temp]" DeleteCommand="DELETE FROM [Wak_update_temp] WHERE [id] = @id">
      <DeleteParameters>
         <asp:Parameter Name="id" Type="Int32" />
      </DeleteParameters>
   </asp:SqlDataSource>
